...
namespace Ecommerce.Areas.Customer.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        // GET: Admin/ProductTypes1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/ProductTypes1/Create
        ...
        {
            var product = await _context.ProductTypes.FirstOrDefaultAsync(c => c.ProductType.ToLower() == productTypes.ProductType.ToLower());
            if(product != null)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["save"] = "Product type has been added";
                return RedirectToAction(nameof(Index));
            }
            return View(productTypes);
        }

        // GET: Admin/ProductTypes1/Edit/5
        ...
        // POST: Admin/ProductTypes1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/ProductTypes1/Delete/5
        ...
        // POST: Admin/ProductTypes1/Delete/5
